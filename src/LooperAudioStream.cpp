...
void LooperAudioStream::_bind_methods(){
    ...
    ClassDB::bind_method(D_METHOD("set_indefinite_looping"), &LooperAudioStream::set_indefinite_loop);
    ClassDB::bind_method(D_METHOD("get_indefinite_looping"), &LooperAudioStream::get_indefinite_looping);
    ...
    ClassDB::add_property("LooperAudioStream", PropertyInfo(Variant::BOOL, "indefinite_loop", PROPERTY_HINT_NONE,
...
void LooperAudioStream::update_loopstream(){
    ...
    }else if (current_loop < loop_amount){
...
void LooperAudioStream::set_indefinite_loop(bool is_infinite){
    indefinite_loop = is_infinite;
}

bool LooperAudioStream::get_indefinite_looping(){
    return indefinite_loop;
}
